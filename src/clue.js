...
// Weapons Arrayname: rope --- weight: 10

const weaponsArray = [
  {name: 'rope', weight: 10}, {name: 'knife', weight: 8}, {name: 'candlestick', weight: 2},
...
function revealMystery(enveloppe) {
  const message = `${enveloppe.suspect.firstName} ${enveloppe.suspect.lastName} killed Mr. Boddy using the ${enveloppe.weapon.name} in the ${enveloppe.room.name}!`
  return message;
